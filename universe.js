...
module.exports = function(service) {
  ...
  function makeAccessor(key) {
    ...
    if (_.isArray(key)) {
      ...
      accessorFunction = new Function('d', String('return ' + JSON.stringify(arrayString).replace(/"/g, '')))
    } else {
      accessorFunction =
        // Index Dimension
